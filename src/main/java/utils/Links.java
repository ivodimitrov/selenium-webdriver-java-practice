...
public class Links {
    ...
    public static final String TOOLSQA_AUTOMATION_PRACTICE_FORM = "http://toolsqa.com/automation-practice-form/";
    ...
    static HashMap<String, String> getPages() {
        ...
        pagesMap.put(TOOLSQA_AUTOMATION_PRACTICE_FORM, HOME_PAGE_TITLE);
